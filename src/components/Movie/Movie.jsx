...
import { Typography, Grid, Grow, Tooltip, Rating, imageListClasses } from '@mui/material';
    ...
    <Grid item xs={12} sm={6} md={4} lg={3} xl={2}>
      <Grow in key={i} timeout={(i + 1) * 250}>
        <Link className={classes.links} to={`/movie/${movie.id}`}>
          ...
          {/* {movie.poster_path
            ? <img alt={movie.title} className={classes.image} src={`https://image.imdb.org/t/p/w500/${movie.poster_path}`} />
